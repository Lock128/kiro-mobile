...
- [ ] 1. Set up project dependencies and core data models
  - [ ] 1.1 Add required dependencies to `pubspec.yaml`
    - Add `webview_flutter`, `webview_flutter_web`, `flutter_secure_storage`, `connectivity_plus`, `provider`, and `glados` (dev dependency)
    - _Requirements: 8.1_

  - [ ] 1.2 Create `AuthState` enum and `AuthCredentials` model
  ...
  - [ ]* 1.3 Write property test: Credential serialization round trip
  ...
  - [ ]* 1.4 Write property test: Credential validation correctness
...
- [ ] 2. Implement CredentialStore with platform-specific storage
  - [ ] 2.1 Create `CredentialStore` abstract interface and platform implementations
  ...
  - [ ]* 2.2 Write unit tests for CredentialStore implementations
...
- [ ] 3. Implement AuthManager
  - [ ] 3.1 Create `AuthManager` implementation
  ...
  - [ ]* 3.2 Write property test: Initialization with valid credentials yields authenticated state
  ...
  - [ ]* 3.3 Write property test: Initialization with invalid or missing credentials yields unauthenticated state
  ...
  - [ ]* 3.4 Write property test: Successful credential capture transitions to authenticated
  ...
  - [ ]* 3.5 Write property test: Sign-out clears credentials and transitions to unauthenticated
  ...
  - [ ]* 3.6 Write property test: Auth error clears credentials and transitions to unauthenticated
...
- [ ] 5. Implement ConnectivityMonitor
  - [ ] 5.1 Create `ConnectivityMonitor` implementation
...
- [ ] 6. Implement UI components
  ...
  - [ ] 6.4 Create `AppShell` root widget
  ...
  - [ ]* 6.5 Write widget tests for UI components
...
- [ ] 7. Wire everything together in main.dart
  - [ ] 7.1 Set up app entry point and dependency injection
  ...
  - [ ] 7.2 Handle platform-specific WebView and browser behavior
